...
function traerProductos(producto, ordenar, strEmpresas) {	
    $.ajax({
    type: "GET",
    url: "http://localhost:8081/search?pais=101&categoria=101&ordenacion="+ ordenar +"&producto="+producto + "&empresas=" + strEmpresas,
    dataType: "text",
    timeout: 600000,
    beforeSend: function(){
...
function liveSearch(keyword) {
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:8081/product/" + keyword,
        dataType: "text",
        timeout: 600000,
        beforeSend: function(){
